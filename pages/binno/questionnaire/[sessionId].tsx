              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-blue-700">
                    Your assessment report will be available immediately after completion. For best experience and to save reports to your profile, consider connecting your Web3 wallet before starting.
                  </p>
                </div>
              </div>
            </div>
