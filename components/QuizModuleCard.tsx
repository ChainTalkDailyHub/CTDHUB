    ...
    <div className={getCardClass()}>
      ...
      <div className="relative z-10 p-1">
        <div className="flex items-start justify-between mb-4">
          ...
          {isCompleted && (
            <div className="flex items-center text-green-500 dark:text-ctd-holo">
          ...
          {isLocked && (
            <div className="flex items-center text-gray-500 dark:text-ctd-mute">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">{module.questions.length} questions</p>
